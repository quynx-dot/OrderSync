          ...
          return (
            <div key={item._id} className="flex items-center rounded-xl bg-white p-4 shadow-sm">
              ...
              <div className="flex-1 px-2">
                ...
                <p className="text-sm text-gray-500">₹{item.price * cartItem.quantity}</p>
              </div>
      ...
      <div className="rounded-xl bg-white p-4 shadow-sm">
        ...
        {subTotal < 250 && (
          <p className="mt-2 text-sm text-gray-500">
            Add items worth ₹{250 - subTotal} more for free delivery
          </p>
        )}
        ...
        <button
          ...
          className="mt-3 w-full rounded-lg bg-[#222222] py-3 text-sm font-semibold text-white hover:bg-gray-800 disabled:opacity-50"
        >
