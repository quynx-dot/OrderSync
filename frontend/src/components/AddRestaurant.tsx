...
return(
  <div className="min-h-screen bg-gray-50 px-4 py-6">
    <div className="mx-auto ma-w-lg rounded-xl bg-white p-6 shadoww-sm space-y-5">
      <h1 className="text-xl font-semi-bold">Add Your Restaurant</h1>
        <input type="text"
